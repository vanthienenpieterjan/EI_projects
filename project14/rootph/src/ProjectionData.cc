...
string baseNameIn="../output/phantom";
string extensionIn=".root";	
string baseNameglobalPosX="../output/globalPosX";
string baseNameglobalPosY="../output/globalPosY";
string baseNameglobalPosZ="../output/globalPosZ";
string baseNameperfectCrystalPosX="../output/perfectCrystalPosX";
string baseNameperfectCrystalPosY="../output/perfectCrystalPosY";
string baseNameperfectCrystalPosZ="../output/perfectCrystalPosZ";
string baseNamevirtualVolumeInPosX="../output/virtualVolumeInPosX";
string baseNamevirtualVolumeInPosY="../output/virtualVolumeInPosY";
string baseNamevirtualVolumeInPosZ="../output/virtualVolumeInPosZ";
string baseNamevirtualVolumeOutPosX="../output/virtualVolumeOutPosX";
string baseNamevirtualVolumeOutPosY="../output/virtualVolumeOutPosY";
string baseNamevirtualVolumeOutPosZ="../output/virtualVolumeOutPosZ";
string baseNameEnergy="../output/energy";
