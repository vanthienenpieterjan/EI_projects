...
string baseNameglobalPosX="../output/ffglobalPosX";
string baseNameglobalPosY="../output/ffglobalPosY";
string baseNameglobalPosZ="../output/ffglobalPosZ";
string baseNameperfectCrystalPosX="../output/ffperfectCrystalPosX";
string baseNameperfectCrystalPosY="../output/ffperfectCrystalPosY";
string baseNameperfectCrystalPosZ="../output/ffperfectCrystalPosZ";
string baseNamevirtualVolumeInPosX="../output/ffvirtualVolumeInPosX";
string baseNamevirtualVolumeInPosY="../output/ffvirtualVolumeInPosY";
string baseNamevirtualVolumeInPosZ="../output/ffvirtualVolumeInPosZ";
string baseNamevirtualVolumeOutPosX="../output/ffvirtualVolumeOutPosX";
string baseNamevirtualVolumeOutPosY="../output/ffvirtualVolumeOutPosY";
string baseNamevirtualVolumeOutPosZ="../output/ffvirtualVolumeOutPosZ";
string baseNameEnergy="../output/ffenergy";
