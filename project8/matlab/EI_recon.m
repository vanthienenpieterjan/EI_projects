...
for i=1:1:300
    ...
    for j=1:1:300
        try
            g_fit_1 = coeffvalues(fit(y_fit.',test_IC_1(i+300*(j-1),:).','gauss1'));
            a1(i,j)=g_fit_1(:,1);
            b1(i,j)=g_fit_1(:,2);
            c1(i,j)=g_fit_1(:,3);
            g_fit_2 = coeffvalues(fit(y_fit.',test_IC_2(i+300*(j-1),:).','gauss1'));
            a2(i,j)=g_fit_2(:,1);
            b2(i,j)=g_fit_2(:,2);
            c2(i,j)=g_fit_2(:,3);
        catch
...
if fig_bool==1
    ...
    colorbar;
    saveas(gcf,'../results/ff1.png');

    figure;
    imshow(data2,[]);
    title('missallignment -8 µm');
    colorbar;
    saveas(gcf,'../results/ff2.png');

    figure;
    imshow(data3,[]);
    title('missallignment 0 µm');
    colorbar;
    saveas(gcf,'../results/ff3.png');

    figure;
    imshow(data4,[]);
    title('missallignment 8 µm');
    colorbar;
    saveas(gcf,'../results/ff4.png');

    figure;
    imshow(data5,[]);
    title('missallignment 16 µm');
    colorbar;
    saveas(gcf,'../results/ff5.png');
end
...
if fig_bool==1
    ...
    title('missallignment -16 µm');
    colorbar;
    saveas(gcf,'../results/ph1.png');

    figure;
    imshow(data12,[]);
    title('missallignment -8 µm');
    colorbar;
    saveas(gcf,'../results/ph2.png');

    figure;
    imshow(data13,[]);
    title('missallignment 0 µm');
    colorbar;
    saveas(gcf,'../results/ph3.png');

    figure;
    imshow(data14,[]);
    title('missallignment 8 µm');
    colorbar;
    saveas(gcf,'../results/ph4.png');

    figure;
    imshow(data15,[]);
    title('missallignment 16 µm');
    colorbar;
    saveas(gcf,'../results/ph5.png');
end
...
if fig_bool==1
    ...
    colorbar;
    saveas(gcf,'../results/attenuation_contrast.png');

    figure;
    imshow(phase_contrast,[]);
    title('phase contrast');
    colorbar;
    saveas(gcf,'../results/phase_contrast.png');

    figure;
    imshow(dark_field_contrast,[]);
    title('dark field contrast');
    colorbar;
    saveas(gcf,'../results/dark_field_contrast.png');
end
...
if fig_bool==1
    ...
    title('dark field');
    colorbar;
    saveas(gcf,'../results/trip_contrast.png');
end